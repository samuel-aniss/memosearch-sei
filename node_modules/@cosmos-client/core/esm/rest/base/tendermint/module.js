...
export async function getLatestValidatorSet(sdk, paginationKey, paginationOffset, paginationLimit, paginationCountTotal, paginationReverse) {
    return new ServiceApi(undefined, sdk.url).getLatestValidatorSet(paginationKey, paginationOffset?.toString(), paginationLimit?.toString(), paginationCountTotal, paginationReverse);
}
