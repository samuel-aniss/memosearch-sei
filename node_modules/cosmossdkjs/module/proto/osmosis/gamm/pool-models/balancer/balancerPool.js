...
export const SmoothWeightChangeParams = {
  ...
  fromJSON(object) {
    return {
      ...
      initialPoolWeights: Array.isArray(object?.initialPoolWeights) ? object.initialPoolWeights.map(e => PoolAsset.fromJSON(e)) : [],
      targetPoolWeights: Array.isArray(object?.targetPoolWeights) ? object.targetPoolWeights.map(e => PoolAsset.fromJSON(e)) : []
    };
  },
...
export const Pool = {
  ...
  fromJSON(object) {
    return {
      ...
      poolAssets: Array.isArray(object?.poolAssets) ? object.poolAssets.map(e => PoolAsset.fromJSON(e)) : [],
