...
var EpochInfo = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      currentEpoch: (0, _helpers.isSet)(object.currentEpoch) ? _helpers.Long.fromString(object.currentEpoch) : _helpers.Long.ZERO,
      ...
      currentEpochStartHeight: (0, _helpers.isSet)(object.currentEpochStartHeight) ? _helpers.Long.fromString(object.currentEpochStartHeight) : _helpers.Long.ZERO
    };
  },
  toJSON: function toJSON(message) {
    ...
    message.currentEpochStartHeight !== undefined && (obj.currentEpochStartHeight = (message.currentEpochStartHeight || _helpers.Long.ZERO).toString());
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var _object$identifier, _object$startTime, _object$duration, _object$currentEpochS, _object$epochCounting;
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.epochs) {
      obj.epochs = message.epochs.map(function (e) {
        return e ? EpochInfo.toJSON(e) : undefined;
      });
    } else {
      obj.epochs = [];
    }
