...
var QueryClientImpl = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(QueryClientImpl, [{
    ...
    key: "distrInfo",
    value: function distrInfo(request) {
    ...
    value: function lockableDurations(request) {
    ...
    value: function incentivizedPools(request) {
    ...
    value: function externalIncentiveGauges(request) {
