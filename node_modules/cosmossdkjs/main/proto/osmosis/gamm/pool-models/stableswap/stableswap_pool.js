...
var Pool = {
  encode: function encode(message) {
    ...
    var _iterator2 = _createForOfIteratorHelper(message.scalingFactor),
        _step2;
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      scalingFactor: Array.isArray(object === null || object === void 0 ? void 0 : object.scalingFactor) ? object.scalingFactor.map(function (e) {
        return _helpers.Long.fromString(e);
      }) : [],
      scalingFactorGovernor: (0, _helpers.isSet)(object.scalingFactorGovernor) ? String(object.scalingFactorGovernor) : ""
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    ...
    if (message.scalingFactor) {
      obj.scalingFactor = message.scalingFactor.map(function (e) {
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.scalingFactor = ((_object$scalingFactor = object.scalingFactor) === null || _object$scalingFactor === void 0 ? void 0 : _object$scalingFactor.map(function (e) {
