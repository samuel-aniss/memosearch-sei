...
var MsgExitPool = {
  encode: function encode(message) {
    ...
    var _iterator2 = _createForOfIteratorHelper(message.tokenOutMins),
        _step2;
...
var MsgJoinSwapShareAmountOut = {
  ...
  fromPartial: function fromPartial(object) {
    var _object$sender6, _object$tokenInDenom2, _object$shareOutAmoun3, _object$tokenInMaxAmo2;
