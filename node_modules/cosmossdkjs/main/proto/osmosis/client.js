...
exports.getSigningOsmosisClientOptions = exports.getSigningOsmosisClient = void 0;
...
var osmosisGammPoolmodelsBalancerTxRegistry = _interopRequireWildcard(require("./gamm/pool-models/balancer/tx.registry"));
...
var osmosisGammPoolmodelsBalancerTxAmino = _interopRequireWildcard(require("./gamm/pool-models/balancer/tx.amino"));
...
var getSigningOsmosisClientOptions = function getSigningOsmosisClientOptions() {
  ...
  var registry = new _protoSigning.Registry([].concat((0, _toConsumableArray2["default"])(defaultTypes), (0, _toConsumableArray2["default"])(osmosisGammPoolmodelsBalancerTxRegistry.registry), (0, _toConsumableArray2["default"])(osmosisGammPoolmodelsStableswapTxRegistry.registry), (0, _toConsumableArray2["default"])(osmosisGammV1beta1TxRegistry.registry), (0, _toConsumableArray2["default"])(osmosisIncentivesTxRegistry.registry), (0, _toConsumableArray2["default"])(osmosisLockupTxRegistry.registry), (0, _toConsumableArray2["default"])(osmosisSuperfluidTxRegistry.registry), (0, _toConsumableArray2["default"])(osmosisTokenfactoryV1beta1TxRegistry.registry)));
  var aminoTypes = new _stargate.AminoTypes(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, osmosisGammPoolmodelsBalancerTxAmino.AminoConverter), osmosisGammPoolmodelsStableswapTxAmino.AminoConverter), osmosisGammV1beta1TxAmino.AminoConverter), osmosisIncentivesTxAmino.AminoConverter), osmosisLockupTxAmino.AminoConverter), osmosisSuperfluidTxAmino.AminoConverter), osmosisTokenfactoryV1beta1TxAmino.AminoConverter));
  return {
    registry: registry,
