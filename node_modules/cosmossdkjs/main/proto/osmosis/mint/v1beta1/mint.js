...
var Params = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      reductionPeriodInEpochs: (0, _helpers.isSet)(object.reductionPeriodInEpochs) ? _helpers.Long.fromString(object.reductionPeriodInEpochs) : _helpers.Long.ZERO,
      ...
      mintingRewardsDistributionStartEpoch: (0, _helpers.isSet)(object.mintingRewardsDistributionStartEpoch) ? _helpers.Long.fromString(object.mintingRewardsDistributionStartEpoch) : _helpers.Long.ZERO
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
