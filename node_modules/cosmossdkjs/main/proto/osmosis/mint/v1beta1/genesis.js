...
function createBaseGenesisState() {
  return {
    minter: undefined,
    params: undefined,
    halvenStartedEpoch: _helpers.Long.ZERO
  };
}
...
var GenesisState = {
  ...
  decode: function decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          message.halvenStartedEpoch = reader.int64();
          break;
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      halvenStartedEpoch: (0, _helpers.isSet)(object.halvenStartedEpoch) ? _helpers.Long.fromString(object.halvenStartedEpoch) : _helpers.Long.ZERO
    };
  },
  toJSON: function toJSON(message) {
    ...
    message.halvenStartedEpoch !== undefined && (obj.halvenStartedEpoch = (message.halvenStartedEpoch || _helpers.Long.ZERO).toString());
    return obj;
  },
  fromPartial: function fromPartial(object) {
    ...
    message.halvenStartedEpoch = object.halvenStartedEpoch !== undefined && object.halvenStartedEpoch !== null ? _helpers.Long.fromValue(object.halvenStartedEpoch) : _helpers.Long.ZERO;
    return message;
  }
};
