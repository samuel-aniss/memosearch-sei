...
export const toJSON = {
  ...
  long(args) {
    ...
    const prop = args.field.name;
    return notUndefinedSetValue(prop, t.callExpression(t.memberExpression(t.logicalExpression('||', t.memberExpression(t.identifier('message'), t.identifier(prop)), getDefaultTSTypeFromProtoType(args.context, args.field, args.isOptional)), t.identifier('toString')), []));
  },
  ...
  bytes(args) {
    ...
    if (args.isOptional) {
      ...
      // message.queryData !== undefined && (obj.queryData = base64FromBytes(message.queryData !== undefined ? message.queryData : new Uint8Array()));
      expr = t.callExpression(t.identifier('base64FromBytes'), [t.conditionalExpression(t.binaryExpression('!==', t.memberExpression(t.identifier('message'), t.identifier(args.field.name)), t.identifier('undefined')), t.memberExpression(t.identifier('message'), t.identifier(args.field.name)), getDefaultTSTypeFromProtoType(args.context, args.field, args.isOptional))]);
    }
