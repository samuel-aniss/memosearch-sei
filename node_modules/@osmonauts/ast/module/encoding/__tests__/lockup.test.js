...
cases('osmosis/lockup/tx', opts => {
  ...
  expectCode(createProtoType(context, 'MsgLockTokens', getNestedProto(ref.traversed).MsgLockTokens));
  expectCode(createObjectWithMethods(context, 'MsgLockTokens', getNestedProto(ref.traversed).MsgLockTokens));
