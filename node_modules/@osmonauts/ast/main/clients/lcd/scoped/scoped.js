...
var lcdArguments = function lcdArguments() {
  return [t.objectProperty(t.identifier('restEndpoint'), t.identifier('restEndpoint'), false, true)];
};

exports.lcdArguments = lcdArguments;

var lcdFuncArguments = function lcdFuncArguments() {
  return [t.objectPattern(lcdArguments())];
};
...
var createScopedLCDFactory = function createScopedLCDFactory(obj, identifier, className) {
  ...
  lcdNestedImportObject(obj, className, lcdClassArguments()), true))]));
};
