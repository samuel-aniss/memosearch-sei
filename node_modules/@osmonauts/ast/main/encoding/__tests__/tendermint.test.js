...
store.traverseAll();
(0, _jestInCase["default"])('ibc/lightclients/tendermint/v1/tendermint', function (opts) {
  var ref = store.findProto('ibc/lightclients/tendermint/v1/tendermint.proto');
  ...
  (0, _testUtils.expectCode)((0, _.createProtoType)(context, 'ClientState', (0, _protoParser.getNestedProto)(ref.traversed).ClientState));
  (0, _testUtils.expectCode)((0, _object.createObjectWithMethods)(context, 'ClientState', (0, _protoParser.getNestedProto)(ref.traversed).ClientState));
  (0, _testUtils.expectCode)((0, _index.makeAminoTypeInterface)({
    context: aminoCtx,
    proto: (0, _protoParser.getNestedProto)(ref.traversed).ClientState
  }));
  (0, _testUtils.expectCode)((0, _index.createAminoConverter)({
    context: aminoCtx,
    root: ref.proto,
    name: 'AminoConverter',
    protos: [(0, _protoParser.getNestedProto)(ref.traversed).ClientState]
  }));
}, [{
  name: 'duration'
}, {
