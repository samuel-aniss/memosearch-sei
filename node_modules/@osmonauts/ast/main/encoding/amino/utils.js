...
var typeUrlToAmino = function typeUrlToAmino(context, typeUrl) {
  var _context$options$amin, _exceptionsToCheck$ty;
  ...
  switch (pkg) {
    ...
    case 'cosmwasm':
      return "wasm/".concat(elements[elements.length - 1]);
