...
var fromJSON = {
  ...
  string: function string(args) {
    ...
    return t.objectProperty(t.identifier(prop), t.conditionalExpression(t.callExpression(t.identifier('isSet'), [t.memberExpression(t.identifier('object'), t.identifier(prop))]), t.callExpression(t.identifier('String'), [t.memberExpression(t.identifier('object'), t.identifier(prop))]), (0, _types2.getDefaultTSTypeFromProtoType)(args.context, args.field, args.isOptional)));
  },
  number: function number(args) {
    var prop = args.field.name;
    args.context.addUtil('isSet');
    return t.objectProperty(t.identifier(prop), t.conditionalExpression(t.callExpression(t.identifier('isSet'), [t.memberExpression(t.identifier('object'), t.identifier(prop))]), t.callExpression(t.identifier('Number'), [t.memberExpression(t.identifier('object'), t.identifier(prop))]), (0, _types2.getDefaultTSTypeFromProtoType)(args.context, args.field, args.isOptional)));
  },
  ...
  "long": function long(args) {
    ...
    return t.objectProperty(t.identifier(prop), t.conditionalExpression(t.callExpression(t.identifier('isSet'), [t.memberExpression(t.identifier('object'), t.identifier(prop))]), t.callExpression(t.memberExpression(t.identifier('Long'), t.identifier('fromString')), [t.memberExpression(t.identifier('object'), t.identifier(prop))]), (0, _types2.getDefaultTSTypeFromProtoType)(args.context, args.field, args.isOptional)));
  },
  ...
  duration: function duration(args) {
    var durationFormat = args.context.pluginValue('typingsFormat.duration');
