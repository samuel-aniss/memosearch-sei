...
var fromPartial = {
  ...
  string: function string(args) {
    ...
    return setNullishCoalescing(prop, (0, _types2.getDefaultTSTypeFromProtoType)(args.context, args.field, args.isOptional));
  },
  ...
  "long": function long(args) {
    var prop = args.field.name;
    return setNotUndefinedAndNotNull(prop, t.callExpression(t.memberExpression(t.identifier('Long'), t.identifier('fromValue')), [t.memberExpression(t.identifier('object'), t.identifier(prop))]), (0, _types2.getDefaultTSTypeFromProtoType)(args.context, args.field, args.isOptional));
  },
