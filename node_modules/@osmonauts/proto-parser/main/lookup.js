...
exports.recursiveLookup = exports.protoScopeImportLookup = exports.protoImportLookup = exports.lookupNested = exports.lookupLocal = exports.lookupAny = exports.lookup = exports.importLookup = exports.externalLookup = void 0;
...
var protoImportLookup = function protoImportLookup(store, ref, name) {
  ...
  .filter(function (proto) {
    return proto.filename === ref.filename || root.imports.includes(proto.filename);
  }).map(function (ref) {
    return {
      "import": ref.filename,
